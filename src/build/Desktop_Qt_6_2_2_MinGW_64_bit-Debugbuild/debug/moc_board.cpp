...
QT_MOC_LITERAL(54, 12), // "readOnlyMode"
QT_MOC_LITERAL(67, 8) // "readOnly"

    },
    "Board\0taskAdded\0\0Task\0task\0taskRemoved\0"
    "id\0taskUpdated\0readOnlyMode\0readOnly"
};
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->readOnlyMode((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Board::readOnlyMode)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void Board::readOnlyMode(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
